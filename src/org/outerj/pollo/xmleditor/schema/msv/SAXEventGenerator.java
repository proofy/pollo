 ...
 *
 * <p>
 * Added notes by Bruno Dumon for the Pollo-specific adjustments:
 *
 * <p>
 * This class is taked from iso-relax.sf.net, I didn't find
 * a license but it's obvisiously licensed the same way as the
 * orginial version.
 *
 * <p>
 * What I added is remembering the last node provided that was streamed,
 * so that Pollo can jump to the location where the element occured.
 *
 * <p>
 * It is also possible to specify a node where the validation should stop.
 * This assumes that the contenthandler is of type PolloMsvVerifier. When
 * the specfied node is streamed, the setStopNow method of PolloMsvVerifier
 * is called. See PolloMsvVerifier for more information.
 *
 * @author
 *            ASAMI, Tomoharu (asami@zeomtech.com)
 *            <a href="kohsuke.kawaguchi@sun.com">Kohsuke KAWAGUCHI</a>
 *            Bruno Dumon (bdumon@users.sourceforge.net)
 */
