...
public class CollapseAction extends AbstractNodeAction
{
    protected static final ResourceManager resourceManager = ResourceManager.getManager(CollapseAction.class);

    public CollapseAction(XmlEditor xmlEditor)
    {
        super(xmlEditor);
